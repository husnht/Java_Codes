...
public class C06_DoWhileLoop {
    public static void main(String[] args) {
        ...
        islemi bitirmek icin 0’a basmasini soyleyin.Kullanici yanlislikla negative sayi girerse
        ...
        do {
            System.out.println("Lutfem toplamak uzere pozitif tamsayi giriniz:");
            sayi= scan.nextInt();
            if(sayi>0){
                pozSayilarTop+=sayi;
                pozSayiAdedi++;
